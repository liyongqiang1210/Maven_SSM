				...
				<ul class="nav" id="side-menu">
							...
							<a data-toggle="dropdown" class="dropdown-toggle"
								href="javascript:void(0);"> <span class="clear"> <span
									class="block m-t-xs" style="font-size: 20px;"> <i
										class="fa fa-area-chart"></i> <strong class="font-bold">hAdmin</strong>
								</span>
							</span>
							</a>
						</div>
					...
					<li><a href="#"><i class="fa fa-users"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="user_manager/user.html"><i
									class="fa fa-users"></i>用户管理</a></li>
							<li><a class="J_menuItem" href="user_manager/role.html"><i
									class="fa fa-user"></i>角色管理</a></li>
							<li><a class="J_menuItem"
								href="user_manager/jurisdiction.html"><i
									class="fa fa-sitemap"></i>权限管理</a></li>
						</ul></li>
					...
					<li><a href="#"><i class="fa fa-desktop"></i> <span
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="#">项目管理 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
							...
							<li><a href="#">博客 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
							...
							<li><a href="#">时间轴 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
							...
							<li><a href="#">单据 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
							...
							<li><a href="#">即时通讯 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
									<li><a class="J_menuItem" href="chat_view.html">聊天窗口</a></li>
								</ul></li>
							<li><a href="#">登录注册相关 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
