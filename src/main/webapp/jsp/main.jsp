            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">Spider</strong>
                                    </span>
                              </span>
                            </a>
                        </div>
                        <div class="logo-element">Spider
                        </div>
                    </li>
					<li>
                    ...
                    <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                        <span class="ng-scope">自己开发的功能</span>
                    </li>
                    <li>
                        <a href="#">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="user-manager/user.html">用户信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="user-manager/role.html">角色信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="user-manager/authority.html">权限信息</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    	...
                    	<ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="blog/bokeyuan.html">博客园</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="http://39.106.154.2:8080/html/blog.html">51cto</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="blog/CSDN.html">CSDN</a>
                            </li>
                        </ul>
                    </li>
                     <li>
                    	<a href="#">
                            ...
                            <span class="nav-label">百度百科</span>
                            <span class="fa arrow"></span>
                    	</a>
                    	<ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="baidu/baidubaike.html">百度百科</a>
                            </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
                    <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                        <span class="ng-scope">系统自带功能</span>
                    </li>
                     <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe id="J_iframe" width="100%" height="100%"
					src="http://localhost/Maven_SSM/user/login" frameborder="0" data-id="index_v1.html"
					seamless></iframe>
			</div>
		</div>
		<!--右侧部分结束-->
