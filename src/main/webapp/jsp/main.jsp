			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="fa fa-cutlery"></i> <span
							class="nav-label">UI元素工具</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="#"> <i class="fa fa fa-bar-chart-o"></i> <span
								...
								<ul class="nav nav-second-level">
									...
									<li><a class="J_menuItem" href="graph_flot.html">Flot</a>
									</li>
							...
							<li><a href="#"><i class="fa fa-flask"></i> <span
								...
								<ul class="nav nav-second-level">
									...
									<li><a class="J_menuItem" href="grid_options.html">栅格</a>
									</li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="row J_mainContent" id="content-main">
				<iframe id="J_iframe" width="100%" height="100%"
					src="" frameborder="0" data-id="index"
					seamless></iframe>
			</div>
		</div>
		<!--右侧部分结束-->
