...
<html>
		...
		<script>
			$(document).ready(function() {
				...
				$(".junshi").click(function() {
					$(".lyq-div-contenxt").load("http://localhost:8080/Maven_SSM/linkage/getLinkageOne");
				});
			});
	...
	<body>
		...
		<div class="div-main">
			<div class="div-left-nav col-xs-2">
				<div class="col-xs col-xs-12">
					<ul class=" nav nav-stacked lyq-ul-color">
						<li>
							<a href="javascript:;" class="lyq-a-news">新闻数据列表</a>
						...
						<li>
							<a href="javascript:;" class="lyq-a-shop">商品数据列表</a>
						...
						<li>
							<a href="javascript:;" class="lyq-a-blog">博客数据列表</a>
						...
						<li>
							<a href="javascript:;" class="lyq-a-forum">论坛数据列表</a>
			...
			<div class="div-right-context col-xs-10">
