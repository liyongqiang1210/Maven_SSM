...
public class Crawler_zsfx extends BreadthCrawler {

	private static final String URL = "http://roll.news.sina.com.cn/news/gnxw/zs-pl/index.shtml";
	...
	private Log log = LogFactory.getLog(Crawler_zsfx.class);

	public Crawler_zsfx(String crawlPath, boolean autoParse) {
	...
	/*
	 * public static void main(String[] args) throws Exception { Crawler_zsfx cs
	 * = new Crawler_zsfx("crawl", true); cs.setThreads(2); cs.setTopN(100);
	 * cs.start(5); }
	 */
