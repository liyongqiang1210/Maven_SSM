...
public class Crawler_gatxw extends BreadthCrawler {

	private static final String URL = "http://roll.news.sina.com.cn/news/gnxw/gatxw/index.shtml";
	...
	public Crawler_gatxw(String crawlPath, boolean autoParse) {
	...
	/*public static void main(String[] args) throws Exception {
		Crawler_gatxw cs = new Crawler_gatxw("crawl", true);
		cs.setThreads(2);
		cs.setTopN(100);
		cs.start(5);
	}*/
