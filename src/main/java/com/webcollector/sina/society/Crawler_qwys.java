...
public class Crawler_qwys extends BreadthCrawler {
	...
	private Log log = LogFactory.getLog(Crawler_qwys.class);

	public Crawler_qwys(String crawlPath, boolean autoParse) {
