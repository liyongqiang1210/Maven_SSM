...
public class Crawler_shwx extends BreadthCrawler {

	private static final String URL = "http://roll.news.sina.com.cn/news/shxw/shwx/index.shtml";
	private static final String SHTML_REGEX = ".*\\/" + new DateUtil().getToday()+"\\/.*\\.shtml";
	private Log log = LogFactory.getLog(Crawler_shwx.class);

	public Crawler_shwx(String crawlPath, boolean autoParse) {
	...
	public static void main(String[] args) throws Exception {
		Crawler_shwx cs = new Crawler_shwx("crawl", true);
		cs.setThreads(2);
		cs.setTopN(100);
		cs.start(5);
	}
