...
public class Crawler_txu extends BreadthCrawler {
	private String URL = "https://jingxuan.tmall.com/sem/tmsearch?spm=a2e1o.8267851.07626516003.3.54f025dbe4dEVp&keyword=t%E6%81%A4%E5%A5%B3&refpid=mm_10011550_0_0&clk1=902ddf8d5fac73fc034905e332b55914&page=1&_input_charset=utf-8";
	...
	public Crawler_txu(String crawlPath, boolean autoParse) {
		...
		for (int i = 1; i < 101; i++) {
			this.addSeed(
					"https://jingxuan.tmall.com/sem/tmsearch?spm=a2e1o.8267851.07626516003.3.54f025dbe4dEVp&keyword=t%E6%81%A4%E5%A5%B3&refpid=mm_10011550_0_0&clk1=902ddf8d5fac73fc034905e332b55914&page="+i+"&_input_charset=utf-8");
		}
