...
public class Crawler_chenshan extends BreadthCrawler {
	private String URL = "https://jingxuan.tmall.com/sem/tmsearch?spm=a2e1o.8267851.07626516003.2.54f025dbDz7AcG&keyword=%E8%A1%AC%E8%A1%AB%E5%A5%B3&refpid=mm_10011550_0_0&clk1=cd7a16d0da94f6a685546c8ac01bdfd1&page=1&_input_charset=utf-8";
	...
	public Crawler_chenshan(String crawlPath, boolean autoParse) {
		...
		for (int i = 1; i < 101; i++) {
			this.addSeed(
					"https://jingxuan.tmall.com/sem/tmsearch?spm=a2e1o.8267851.07626516003.2.54f025dbDz7AcG&keyword=%E8%A1%AC%E8%A1%AB%E5%A5%B3&refpid=mm_10011550_0_0&clk1=cd7a16d0da94f6a685546c8ac01bdfd1&page="+i+"&_input_charset=utf-8");
		}
