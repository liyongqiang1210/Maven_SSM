...
public class Crawler_lianyiqun extends BreadthCrawler {
	...
	public Crawler_lianyiqun(String crawlPath, boolean autoParse) {
		...
		for (int i = 1; i < 101; i++) {
			this.addSeed(
					"https://jingxuan.tmall.com/sem/tmsearch?spm=a2e1o.8267851.07626516003.1.54f025db7WD7rH&keyword=%E8%BF%9E%E8%A1%A3%E8%A3%99&refpid=mm_10011550_0_0&clk1=2a87579536548c22ac327c3478abb256&page="+i+"&_input_charset=utf-8");
		}
