...
public class Crawler_erji extends BreadthCrawler {
	private String URL = "https://jingxuan.tmall.com/sem/tmsearch?spm=a2e1o.8267851.07626516003.1.54f025dbOvZbyN&keyword=%E8%80%B3%E6%9C%BA&refpid=mm_10011550_0_0&clk1=4884cc04486feb476edb6cb1e5d98ea3&page=1&_input_charset=utf-8";
	...
	public Crawler_erji(String crawlPath, boolean autoParse) {
		...
		for (int i = 1; i < 101; i++) {
			this.addSeed(
					"https://jingxuan.tmall.com/sem/tmsearch?spm=a2e1o.8267851.07626516003.1.54f025dbOvZbyN&keyword=%E8%80%B3%E6%9C%BA&refpid=mm_10011550_0_0&clk1=4884cc04486feb476edb6cb1e5d98ea3&page="
	...
	public void visit(Page page, CrawlDatums next) {
		...
		try {
			...
			for (Element el : els) {
				...
				int h = jdbc.selectShop(tb_shop_name);
				if (j < 1 && h < 1) {
					log.debug("#####################第" + i + "条#########################");
