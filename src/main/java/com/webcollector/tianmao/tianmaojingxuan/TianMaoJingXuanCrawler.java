package com.webcollector.tianmao.tianmaojingxuan;
 ...
 *
 */
public abstract class TianMaoJingXuanCrawler extends BreadthCrawler {
	private Log log = LogFactory.getLog(Crawler_gdxw.class);

	public TianMaoJingXuanCrawler(String crawlPath, boolean autoParse) {
