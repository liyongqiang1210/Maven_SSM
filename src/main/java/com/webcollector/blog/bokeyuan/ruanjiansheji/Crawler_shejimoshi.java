...
public class Crawler_shejimoshi extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_shejimoshi(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 50; i++) {
			this.addSeed("https://www.cnblogs.com/cate/dp/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_shejimoshi cs =new Crawler_shejimoshi("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
