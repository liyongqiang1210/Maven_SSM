...
public class Crawler_jiagousheji extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_jiagousheji(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 70; i++) {
			this.addSeed("https://www.cnblogs.com/cate/c/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_jiagousheji cs =new Crawler_jiagousheji("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
