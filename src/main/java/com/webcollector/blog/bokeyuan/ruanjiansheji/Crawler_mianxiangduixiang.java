package com.webcollector.blog.bokeyuan.ruanjiansheji;
...
public class Crawler_mianxiangduixiang extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_mianxiangduixiang(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 50; i++) {
			this.addSeed("https://www.cnblogs.com/cate/108702/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_mianxiangduixiang cs =new Crawler_mianxiangduixiang("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
