...
public class Crawler_lingyuqudongsheji extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_lingyuqudongsheji(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 10; i++) {
			this.addSeed("https://www.cnblogs.com/cate/ddd/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_lingyuqudongsheji cs =new Crawler_lingyuqudongsheji("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
