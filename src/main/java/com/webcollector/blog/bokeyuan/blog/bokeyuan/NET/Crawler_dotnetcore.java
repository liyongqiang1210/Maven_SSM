...
public class Crawler_dotnetcore extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_dotnetcore(String crawlPath, boolean autoParse) {
	...
	public static void main(String[] args) throws Exception {
		Crawler_dotnetcore cs =new Crawler_dotnetcore("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
