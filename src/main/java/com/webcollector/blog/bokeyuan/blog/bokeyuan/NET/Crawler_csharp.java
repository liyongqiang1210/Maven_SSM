...
public class Crawler_csharp extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_csharp(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 100; i++) {
			this.addSeed("https://www.cnblogs.com/cate/csharp/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_csharp cs =new Crawler_csharp("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
