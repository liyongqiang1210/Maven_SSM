...
public class Crawler_php extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_php(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 200; i++) {
			this.addSeed("https://www.cnblogs.com/cate/php/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_php cs =new Crawler_php("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
