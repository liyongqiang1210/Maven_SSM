...
public class Crawler_java extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_java(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 200; i++) {
			this.addSeed("https://www.cnblogs.com/cate/java/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_java cs =new Crawler_java("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
