...
public class Crawler_python extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_python(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 200; i++) {
			this.addSeed("https://www.cnblogs.com/cate/python/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_python cs =new Crawler_python("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
