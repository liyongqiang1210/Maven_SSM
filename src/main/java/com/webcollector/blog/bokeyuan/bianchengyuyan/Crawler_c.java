...
public class Crawler_c extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_c(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 50; i++) {
			this.addSeed("https://www.cnblogs.com/cate/design/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_c cs =new Crawler_c("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
