...
public class Crawler_html5 extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_html5(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 200; i++) {
			this.addSeed("https://www.cnblogs.com/cate/html5/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_html5 cs =new Crawler_html5("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
