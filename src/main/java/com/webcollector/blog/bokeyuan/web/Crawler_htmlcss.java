...
public class Crawler_htmlcss extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_htmlcss(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 200; i++) {
			this.addSeed("https://www.cnblogs.com/cate/web/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_htmlcss cs =new Crawler_htmlcss("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
