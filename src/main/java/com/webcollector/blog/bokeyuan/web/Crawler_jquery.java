...
public class Crawler_jquery extends BreadthCrawler {

	private Log log = LogFactory.getLog(Crawler_gatxw.class);

	public Crawler_jquery(String crawlPath, boolean autoParse) {
		super(crawlPath, autoParse);
		for (int i = 0; i <= 200; i++) {
			this.addSeed("https://www.cnblogs.com/cate/javascript/" + i);
		}
	...
	public static void main(String[] args) throws Exception {
		Crawler_jquery cs =new Crawler_jquery("crawl", true);
		cs.setThreads(1);
		cs.setTopN(100);
		cs.start(2);
	}
